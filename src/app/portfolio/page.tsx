            ...
            <Segment inverted>
              <ul style={{}}>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      An interactive map of Barbuda that displays
                      photogrammetric models of marked sites.
                    </li>
                  </ul>
                </li>
                <li>
                    ...
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          screen) up so that it is visible to the camera. A
                          model of the Mortello Tower should appear.
                        </li>
                      </ul>
                    </li>
                  </ul>
